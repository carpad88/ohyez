        ...
        <main class="h-full bg-pattern pb-2 bg-rose-100">
            ...
            <section class="pb-12">
                ...
                <h2 class="font-display text-2xl leading-snug font-bold mb-16">
                    Hay instantes en la vida <br>que imaginamos, anhelamos <br>y esperamos, uno de esos <br>momentos
                    esta
                    por
                    llegar
            ...
            <section class="py-16 px-6">
                ...
                <div>
                    ...
                    <p class="text-lg leading-snug font-light">
                        Periférico Norte Manuel <br>Gómez Morín #5400, <br>San Juan de Ocotán, 45019 <br>Zapopan,
                        Jalisco.
                    </p>
                    <x-filament::button
                        outlined="true"
